...
class AISDictionaries:
    ...
    Aid_to_Navifgation_Type = {
        ...
        3 : 'Fixed structure::  off::  shore, such as oil::  platforms, wind::  farms, rigs.'
            '(Note: This::  code::  should::  identify::  an::  obstruction::  that is fitted::  '
            'with an Aid-to-Navigation AIS station.)',
    ...
    def nibble_to_armour(self, input_nibble: str) -> str:
        # takes six bit binary nibble returns armoured character

        for key, nibble in self.payload_armour.items():
            if nibble == input_nibble:
                return key
